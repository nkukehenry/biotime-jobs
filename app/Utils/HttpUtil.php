...
class HttpUtil{
    ...
    public  function __construct(){
        ...
        $this->client = new Client(['base_uri' => env('BIO_URL')]);
        $this->ihrisclient = new Client(['base_uri' => env('iHRIS_URL')]);
        $this->ucmbihrisclient = new Client(['base_uri' => env('UCMBiHRIS_URL')]);
    }
